...
CREATE TABLE public.pg_listings (
  ...
  gender_type TEXT NOT NULL DEFAULT 'any' CHECK (gender_type IN ('male', 'female', 'any')),
  room_type TEXT NOT NULL DEFAULT 'sharing' CHECK (room_type IN ('single', 'double', 'triple', 'sharing')),
